...
//Split second half
    ...
    // }
        ...
        if ((endpoints[0] >= endpoints[2] && endpoints[0] <= endpoints[3]) || (endpoints[1] >= endpoints[2] && endpoints[1] <= endpoints[3]))
        {
            most++;
        }
        else if ((endpoints[2] >= endpoints[0] && endpoints[2] <= endpoints[1]) || (endpoints[3] >= endpoints[0] && endpoints[3] <= endpoints[1]))
        {
            most++;
        }
    }
